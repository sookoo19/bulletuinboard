...
export const PostList = () => {
  ...
  useEffect(() => {
    fetch(
      `https://railway.bulletinboard.techtrain.dev/threads/${thread_id}/posts?offset=${
      ...
      .then((data) => {
        ...
        setPosts(Array.isArray(data.posts) ? data.posts : []); //Array.isArray は、値が配列かどうかを判定する
      })
      .catch((err) => console.error(err));
  }, [thread_id, page]);
      ...
      <div className="table_and_form">
        ...
        <div className="postFormWrapper">
          <form className="postForm" onSubmit={handleSubmit}>
            ...
            <div>
              <button className="postForm_button" type="submit">
                投稿する
              </button>
            </div>
          </form>
