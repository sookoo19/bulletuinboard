...
export const CreateThreads = () => {
    ...
    useEffect(() => {
        ...
        .then(data => {
            ...
            (a.translations?.jpn?.common || a.name.common)
            .localeCompare(b.translations?.jpn?.common || b.name.common, "ja")
            );
    ...
    useEffect(() => {
        if (selected) {
        fetch(`https://restcountries.com/v3.1/name/${encodeURIComponent(selected)}?fullText=true`)
            .then(res => res.json())
    ...
    const handleSubmit = async (e) => {
        ...
        const body = {
            ...
            ? selectedCountry.translations?.jpn?.common || selectedCountry.name.common
            : "",
    ...
    return(
        <div>
            ...
            <form className="threadsForm" onSubmit={handleSubmit}>
                <label className="selectcountry" id="selectcountry">対象国：</label>
                <br />
